...
class Gripper_Feedback(metaclass=Metaclass_Gripper_Feedback):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.gripper_progress = kwargs.get('gripper_progress', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.gripper_progress != other.gripper_progress:
            return False
        return True
    ...
    @property
    def gripper_progress(self):
        """Message field 'gripper_progress'."""
        return self._gripper_progress

    @gripper_progress.setter
    def gripper_progress(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'gripper_progress' field must be of type 'float'"
        self._gripper_progress = value
...
class Metaclass_Gripper_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from pnp_msgs.action import Gripper
...
class Gripper_SendGoal_Request(metaclass=Metaclass_Gripper_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'pnp_msgs/Gripper_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['pnp_msgs', 'action'], 'Gripper_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from pnp_msgs.action._gripper import Gripper_Goal
...
class Metaclass_Gripper_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'pnp_msgs.action.Gripper_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from pnp_msgs.action import _gripper
...
class Gripper_SendGoal(metaclass=Metaclass_Gripper_SendGoal):
    from pnp_msgs.action._gripper import Gripper_SendGoal_Request as Request
    from pnp_msgs.action._gripper import Gripper_SendGoal_Response as Response
...
class Gripper_GetResult_Response(metaclass=Metaclass_Gripper_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'pnp_msgs/Gripper_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['pnp_msgs', 'action'], 'Gripper_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from pnp_msgs.action._gripper import Gripper_Result
...
class Metaclass_Gripper_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'pnp_msgs.action.Gripper_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Gripper_GetResult(metaclass=Metaclass_Gripper_GetResult):
    from pnp_msgs.action._gripper import Gripper_GetResult_Request as Request
    from pnp_msgs.action._gripper import Gripper_GetResult_Response as Response
...
class Metaclass_Gripper_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'pnp_msgs.action.Gripper_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Gripper_FeedbackMessage(metaclass=Metaclass_Gripper_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'pnp_msgs/Gripper_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['pnp_msgs', 'action'], 'Gripper_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from pnp_msgs.action._gripper import Gripper_Feedback
...
class Gripper(metaclass=Metaclass_Gripper):
    ...
    from pnp_msgs.action._gripper import Gripper_Goal as Goal
    # The result message defined in the action definition.
    from pnp_msgs.action._gripper import Gripper_Result as Result
    # The feedback message defined in the action definition.
    from pnp_msgs.action._gripper import Gripper_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from pnp_msgs.action._gripper import Gripper_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from pnp_msgs.action._gripper import Gripper_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from pnp_msgs.action._gripper import Gripper_FeedbackMessage as FeedbackMessage
