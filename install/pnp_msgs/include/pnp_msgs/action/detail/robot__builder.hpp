...
class Init_Robot_Goal_joint_position
{
public:
  Init_Robot_Goal_joint_position()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::pnp_msgs::action::Robot_Goal joint_position(::pnp_msgs::action::Robot_Goal::_joint_position_type arg)
  {
...
{
  return pnp_msgs::action::builder::Init_Robot_Goal_joint_position();
}
...
class Init_Robot_Result_result
{
public:
  Init_Robot_Result_result()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::pnp_msgs::action::Robot_Result result(::pnp_msgs::action::Robot_Result::_result_type arg)
  {
...
{
  return pnp_msgs::action::builder::Init_Robot_Result_result();
}
