...
struct PickAndPlace_Goal_
{
  ...
  explicit PickAndPlace_Goal_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    ...
    {
      std::fill<typename std::array<float, 2>::iterator, float>(this->pick_position.begin(), this->pick_position.end(), 0.0f);
      std::fill<typename std::array<float, 2>::iterator, float>(this->place_position.begin(), this->place_position.end(), 0.0f);
    }
  }
  ...
  using _pick_position_type =
    std::array<float, 2>;
  _pick_position_type pick_position;
  using _place_position_type =
    std::array<float, 2>;
  _place_position_type place_position;

  // setters for named parameter idiom
  Type & set__pick_position(
    const std::array<float, 2> & _arg)
  {
    this->pick_position = _arg;
    return *this;
  }
  Type & set__place_position(
    const std::array<float, 2> & _arg)
  {
    this->place_position = _arg;
    return *this;
  }
  ...
  {
    if (this->pick_position != other.pick_position) {
      return false;
    }
    if (this->place_position != other.place_position) {
      return false;
    }
    return true;
  }
...
struct PickAndPlace_Feedback_
{
  ...
  // field types and members
  using _robot_gripper_position_type =
    std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>;
  _robot_gripper_position_type robot_gripper_position;

  // setters for named parameter idiom
  Type & set__robot_gripper_position(
    const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> & _arg)
  {
    this->robot_gripper_position = _arg;
    return *this;
  }
  ...
  {
    if (this->robot_gripper_position != other.robot_gripper_position) {
      return false;
    }
    return true;
  }
