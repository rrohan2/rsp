...
class Init_PickAndPlace_Goal_place_position
{
public:
  explicit Init_PickAndPlace_Goal_place_position(::pnp_msgs::action::PickAndPlace_Goal & msg)
  : msg_(msg)
  {}
  ::pnp_msgs::action::PickAndPlace_Goal place_position(::pnp_msgs::action::PickAndPlace_Goal::_place_position_type arg)
  {
    msg_.place_position = std::move(arg);
...
class Init_PickAndPlace_Goal_pick_position
{
public:
  Init_PickAndPlace_Goal_pick_position()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_PickAndPlace_Goal_place_position pick_position(::pnp_msgs::action::PickAndPlace_Goal::_pick_position_type arg)
  {
    msg_.pick_position = std::move(arg);
    return Init_PickAndPlace_Goal_place_position(msg_);
  }
...
{
  return pnp_msgs::action::builder::Init_PickAndPlace_Goal_pick_position();
}
...
class Init_PickAndPlace_Result_result
{
public:
  Init_PickAndPlace_Result_result()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::pnp_msgs::action::PickAndPlace_Result result(::pnp_msgs::action::PickAndPlace_Result::_result_type arg)
  {
...
{
  return pnp_msgs::action::builder::Init_PickAndPlace_Result_result();
}
...
class Init_PickAndPlace_Feedback_robot_gripper_position
{
public:
  Init_PickAndPlace_Feedback_robot_gripper_position()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::pnp_msgs::action::PickAndPlace_Feedback robot_gripper_position(::pnp_msgs::action::PickAndPlace_Feedback::_robot_gripper_position_type arg)
  {
    msg_.robot_gripper_position = std::move(arg);
    return std::move(msg_);
  }
...
{
  return pnp_msgs::action::builder::Init_PickAndPlace_Feedback_robot_gripper_position();
}
