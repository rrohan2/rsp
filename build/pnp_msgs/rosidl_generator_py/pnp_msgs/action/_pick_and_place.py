...
class PickAndPlace_Goal(metaclass=Metaclass_PickAndPlace_Goal):
    ...
    _fields_and_field_types = {
        'pick_position': 'float[2]',
        'place_position': 'float[2]',
    }
    ...
    def __init__(self, **kwargs):
        ...
        if 'pick_position' not in kwargs:
            self.pick_position = numpy.zeros(2, dtype=numpy.float32)
        else:
            self.pick_position = numpy.array(kwargs.get('pick_position'), dtype=numpy.float32)
            assert self.pick_position.shape == (2, )
        if 'place_position' not in kwargs:
            self.place_position = numpy.zeros(2, dtype=numpy.float32)
        else:
            self.place_position = numpy.array(kwargs.get('place_position'), dtype=numpy.float32)
            assert self.place_position.shape == (2, )
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if all(self.pick_position != other.pick_position):
            return False
        if all(self.place_position != other.place_position):
            return False
        return True
    ...
    def pick_position(self):
        """Message field 'pick_position'."""
        return self._pick_position

    @pick_position.setter
    def pick_position(self, value):
        if isinstance(value, numpy.ndarray):
            assert value.dtype == numpy.float32, \
                "The 'pick_position' numpy.ndarray() must have the dtype of 'numpy.float32'"
            assert value.size == 2, \
                "The 'pick_position' numpy.ndarray() must have a size of 2"
            self._pick_position = value
            return
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'pick_position' field must be a set or sequence with length 2 and each value of type 'float'"
        self._pick_position = numpy.array(value, dtype=numpy.float32)

    @property
    def place_position(self):
        """Message field 'place_position'."""
        return self._place_position

    @place_position.setter
    def place_position(self, value):
        if isinstance(value, numpy.ndarray):
            assert value.dtype == numpy.float32, \
                "The 'place_position' numpy.ndarray() must have the dtype of 'numpy.float32'"
            assert value.size == 2, \
                "The 'place_position' numpy.ndarray() must have a size of 2"
            self._place_position = value
            return
        if __debug__:
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'place_position' field must be a set or sequence with length 2 and each value of type 'float'"
        self._place_position = numpy.array(value, dtype=numpy.float32)
...
class PickAndPlace_Feedback(metaclass=Metaclass_PickAndPlace_Feedback):
    ...
    __slots__ = [
        '_robot_gripper_position',
    ]

    _fields_and_field_types = {
        'robot_gripper_position': 'string',
    }
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.robot_gripper_position = kwargs.get('robot_gripper_position', str())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.robot_gripper_position != other.robot_gripper_position:
            return False
        return True
    ...
    @property
    def robot_gripper_position(self):
        """Message field 'robot_gripper_position'."""
        return self._robot_gripper_position

    @robot_gripper_position.setter
    def robot_gripper_position(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'robot_gripper_position' field must be of type 'str'"
        self._robot_gripper_position = value
...
class Metaclass_PickAndPlace_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from pnp_msgs.action import PickAndPlace
...
class PickAndPlace_SendGoal_Request(metaclass=Metaclass_PickAndPlace_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'pnp_msgs/PickAndPlace_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['pnp_msgs', 'action'], 'PickAndPlace_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from pnp_msgs.action._pick_and_place import PickAndPlace_Goal
...
class Metaclass_PickAndPlace_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'pnp_msgs.action.PickAndPlace_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from pnp_msgs.action import _pick_and_place
...
class PickAndPlace_SendGoal(metaclass=Metaclass_PickAndPlace_SendGoal):
    from pnp_msgs.action._pick_and_place import PickAndPlace_SendGoal_Request as Request
    from pnp_msgs.action._pick_and_place import PickAndPlace_SendGoal_Response as Response
...
class PickAndPlace_GetResult_Response(metaclass=Metaclass_PickAndPlace_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'pnp_msgs/PickAndPlace_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['pnp_msgs', 'action'], 'PickAndPlace_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from pnp_msgs.action._pick_and_place import PickAndPlace_Result
...
class Metaclass_PickAndPlace_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'pnp_msgs.action.PickAndPlace_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PickAndPlace_GetResult(metaclass=Metaclass_PickAndPlace_GetResult):
    from pnp_msgs.action._pick_and_place import PickAndPlace_GetResult_Request as Request
    from pnp_msgs.action._pick_and_place import PickAndPlace_GetResult_Response as Response
...
class Metaclass_PickAndPlace_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'pnp_msgs.action.PickAndPlace_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PickAndPlace_FeedbackMessage(metaclass=Metaclass_PickAndPlace_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'pnp_msgs/PickAndPlace_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['pnp_msgs', 'action'], 'PickAndPlace_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from pnp_msgs.action._pick_and_place import PickAndPlace_Feedback
...
class PickAndPlace(metaclass=Metaclass_PickAndPlace):
    ...
    from pnp_msgs.action._pick_and_place import PickAndPlace_Goal as Goal
    # The result message defined in the action definition.
    from pnp_msgs.action._pick_and_place import PickAndPlace_Result as Result
    # The feedback message defined in the action definition.
    from pnp_msgs.action._pick_and_place import PickAndPlace_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from pnp_msgs.action._pick_and_place import PickAndPlace_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from pnp_msgs.action._pick_and_place import PickAndPlace_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from pnp_msgs.action._pick_and_place import PickAndPlace_FeedbackMessage as FeedbackMessage
