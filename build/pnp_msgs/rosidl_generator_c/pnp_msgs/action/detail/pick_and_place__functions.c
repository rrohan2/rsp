...
pnp_msgs__action__PickAndPlace_Goal__are_equal(const pnp_msgs__action__PickAndPlace_Goal * lhs, const pnp_msgs__action__PickAndPlace_Goal * rhs)
{
  ...
  for (size_t i = 0; i < 2; ++i) {
    if (lhs->pick_position[i] != rhs->pick_position[i]) {
      return false;
    }
  }
  // place_position
  for (size_t i = 0; i < 2; ++i) {
    if (lhs->place_position[i] != rhs->place_position[i]) {
      return false;
    }
  }
  return true;
  ...
  pnp_msgs__action__PickAndPlace_Goal * output)
{
  ...
  // pick_position
  for (size_t i = 0; i < 2; ++i) {
    output->pick_position[i] = input->pick_position[i];
  }
  // place_position
  for (size_t i = 0; i < 2; ++i) {
    output->place_position[i] = input->place_position[i];
  }
  return true;
}
...
{
  pnp_msgs__action__PickAndPlace_Goal * msg = (pnp_msgs__action__PickAndPlace_Goal *)malloc(sizeof(pnp_msgs__action__PickAndPlace_Goal));
  if (!msg) {
    return NULL;
  }
...
pnp_msgs__action__PickAndPlace_Goal__Sequence__init(pnp_msgs__action__PickAndPlace_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (pnp_msgs__action__PickAndPlace_Goal *)calloc(size, sizeof(pnp_msgs__action__PickAndPlace_Goal));
    if (!data) {
      return false;
    }
...
{
  pnp_msgs__action__PickAndPlace_Goal__Sequence * array = (pnp_msgs__action__PickAndPlace_Goal__Sequence *)malloc(sizeof(pnp_msgs__action__PickAndPlace_Goal__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  pnp_msgs__action__PickAndPlace_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    pnp_msgs__action__PickAndPlace_Goal * data =
      (pnp_msgs__action__PickAndPlace_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pnp_msgs__action__PickAndPlace_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          pnp_msgs__action__PickAndPlace_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  pnp_msgs__action__PickAndPlace_Result * msg = (pnp_msgs__action__PickAndPlace_Result *)malloc(sizeof(pnp_msgs__action__PickAndPlace_Result));
  if (!msg) {
    return NULL;
  }
...
pnp_msgs__action__PickAndPlace_Result__Sequence__init(pnp_msgs__action__PickAndPlace_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (pnp_msgs__action__PickAndPlace_Result *)calloc(size, sizeof(pnp_msgs__action__PickAndPlace_Result));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  pnp_msgs__action__PickAndPlace_Result__Sequence * array = (pnp_msgs__action__PickAndPlace_Result__Sequence *)malloc(sizeof(pnp_msgs__action__PickAndPlace_Result__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  pnp_msgs__action__PickAndPlace_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    pnp_msgs__action__PickAndPlace_Result * data =
      (pnp_msgs__action__PickAndPlace_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pnp_msgs__action__PickAndPlace_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          pnp_msgs__action__PickAndPlace_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
pnp_msgs__action__PickAndPlace_Feedback__init(pnp_msgs__action__PickAndPlace_Feedback * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->robot_gripper_position)) {
...
pnp_msgs__action__PickAndPlace_Feedback__fini(pnp_msgs__action__PickAndPlace_Feedback * msg)
{
  ...
  // robot_gripper_position
  rosidl_runtime_c__String__fini(&msg->robot_gripper_position);
}
...
pnp_msgs__action__PickAndPlace_Feedback__are_equal(const pnp_msgs__action__PickAndPlace_Feedback * lhs, const pnp_msgs__action__PickAndPlace_Feedback * rhs)
{
  ...
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->robot_gripper_position), &(rhs->robot_gripper_position)))
  {
    return false;
  }
  return true;
  ...
  pnp_msgs__action__PickAndPlace_Feedback * output)
{
  ...
  if (!rosidl_runtime_c__String__copy(
      &(input->robot_gripper_position), &(output->robot_gripper_position)))
  {
    return false;
  }
  return true;
...
{
  pnp_msgs__action__PickAndPlace_Feedback * msg = (pnp_msgs__action__PickAndPlace_Feedback *)malloc(sizeof(pnp_msgs__action__PickAndPlace_Feedback));
  if (!msg) {
    return NULL;
  }
...
pnp_msgs__action__PickAndPlace_Feedback__Sequence__init(pnp_msgs__action__PickAndPlace_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (pnp_msgs__action__PickAndPlace_Feedback *)calloc(size, sizeof(pnp_msgs__action__PickAndPlace_Feedback));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  pnp_msgs__action__PickAndPlace_Feedback__Sequence * array = (pnp_msgs__action__PickAndPlace_Feedback__Sequence *)malloc(sizeof(pnp_msgs__action__PickAndPlace_Feedback__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  pnp_msgs__action__PickAndPlace_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    pnp_msgs__action__PickAndPlace_Feedback * data =
      (pnp_msgs__action__PickAndPlace_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pnp_msgs__action__PickAndPlace_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          pnp_msgs__action__PickAndPlace_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  pnp_msgs__action__PickAndPlace_SendGoal_Request * msg = (pnp_msgs__action__PickAndPlace_SendGoal_Request *)malloc(sizeof(pnp_msgs__action__PickAndPlace_SendGoal_Request));
  if (!msg) {
    return NULL;
  }
...
pnp_msgs__action__PickAndPlace_SendGoal_Request__Sequence__init(pnp_msgs__action__PickAndPlace_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (pnp_msgs__action__PickAndPlace_SendGoal_Request *)calloc(size, sizeof(pnp_msgs__action__PickAndPlace_SendGoal_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  pnp_msgs__action__PickAndPlace_SendGoal_Request__Sequence * array = (pnp_msgs__action__PickAndPlace_SendGoal_Request__Sequence *)malloc(sizeof(pnp_msgs__action__PickAndPlace_SendGoal_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  pnp_msgs__action__PickAndPlace_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    pnp_msgs__action__PickAndPlace_SendGoal_Request * data =
      (pnp_msgs__action__PickAndPlace_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pnp_msgs__action__PickAndPlace_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          pnp_msgs__action__PickAndPlace_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  pnp_msgs__action__PickAndPlace_SendGoal_Response * msg = (pnp_msgs__action__PickAndPlace_SendGoal_Response *)malloc(sizeof(pnp_msgs__action__PickAndPlace_SendGoal_Response));
  if (!msg) {
    return NULL;
  }
...
pnp_msgs__action__PickAndPlace_SendGoal_Response__Sequence__init(pnp_msgs__action__PickAndPlace_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (pnp_msgs__action__PickAndPlace_SendGoal_Response *)calloc(size, sizeof(pnp_msgs__action__PickAndPlace_SendGoal_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  pnp_msgs__action__PickAndPlace_SendGoal_Response__Sequence * array = (pnp_msgs__action__PickAndPlace_SendGoal_Response__Sequence *)malloc(sizeof(pnp_msgs__action__PickAndPlace_SendGoal_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  pnp_msgs__action__PickAndPlace_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    pnp_msgs__action__PickAndPlace_SendGoal_Response * data =
      (pnp_msgs__action__PickAndPlace_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pnp_msgs__action__PickAndPlace_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          pnp_msgs__action__PickAndPlace_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  pnp_msgs__action__PickAndPlace_GetResult_Request * msg = (pnp_msgs__action__PickAndPlace_GetResult_Request *)malloc(sizeof(pnp_msgs__action__PickAndPlace_GetResult_Request));
  if (!msg) {
    return NULL;
  }
...
pnp_msgs__action__PickAndPlace_GetResult_Request__Sequence__init(pnp_msgs__action__PickAndPlace_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (pnp_msgs__action__PickAndPlace_GetResult_Request *)calloc(size, sizeof(pnp_msgs__action__PickAndPlace_GetResult_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  pnp_msgs__action__PickAndPlace_GetResult_Request__Sequence * array = (pnp_msgs__action__PickAndPlace_GetResult_Request__Sequence *)malloc(sizeof(pnp_msgs__action__PickAndPlace_GetResult_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  pnp_msgs__action__PickAndPlace_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    pnp_msgs__action__PickAndPlace_GetResult_Request * data =
      (pnp_msgs__action__PickAndPlace_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pnp_msgs__action__PickAndPlace_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          pnp_msgs__action__PickAndPlace_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  pnp_msgs__action__PickAndPlace_GetResult_Response * msg = (pnp_msgs__action__PickAndPlace_GetResult_Response *)malloc(sizeof(pnp_msgs__action__PickAndPlace_GetResult_Response));
  if (!msg) {
    return NULL;
  }
...
pnp_msgs__action__PickAndPlace_GetResult_Response__Sequence__init(pnp_msgs__action__PickAndPlace_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (pnp_msgs__action__PickAndPlace_GetResult_Response *)calloc(size, sizeof(pnp_msgs__action__PickAndPlace_GetResult_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  pnp_msgs__action__PickAndPlace_GetResult_Response__Sequence * array = (pnp_msgs__action__PickAndPlace_GetResult_Response__Sequence *)malloc(sizeof(pnp_msgs__action__PickAndPlace_GetResult_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  pnp_msgs__action__PickAndPlace_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    pnp_msgs__action__PickAndPlace_GetResult_Response * data =
      (pnp_msgs__action__PickAndPlace_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pnp_msgs__action__PickAndPlace_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          pnp_msgs__action__PickAndPlace_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  pnp_msgs__action__PickAndPlace_FeedbackMessage * msg = (pnp_msgs__action__PickAndPlace_FeedbackMessage *)malloc(sizeof(pnp_msgs__action__PickAndPlace_FeedbackMessage));
  if (!msg) {
    return NULL;
  }
...
pnp_msgs__action__PickAndPlace_FeedbackMessage__Sequence__init(pnp_msgs__action__PickAndPlace_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (pnp_msgs__action__PickAndPlace_FeedbackMessage *)calloc(size, sizeof(pnp_msgs__action__PickAndPlace_FeedbackMessage));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  pnp_msgs__action__PickAndPlace_FeedbackMessage__Sequence * array = (pnp_msgs__action__PickAndPlace_FeedbackMessage__Sequence *)malloc(sizeof(pnp_msgs__action__PickAndPlace_FeedbackMessage__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  pnp_msgs__action__PickAndPlace_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    pnp_msgs__action__PickAndPlace_FeedbackMessage * data =
      (pnp_msgs__action__PickAndPlace_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pnp_msgs__action__PickAndPlace_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          pnp_msgs__action__PickAndPlace_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
