...
static const _Average_Request_type_support_symbol_names_t _Average_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, assignment1_msgs, srv, Average_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, assignment1_msgs, srv, Average_Request)),
  }
};
...
{
  return &::assignment1_msgs::srv::rosidl_typesupport_cpp::Average_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, assignment1_msgs, srv, Average_Request)() {
  return get_message_type_support_handle<assignment1_msgs::srv::Average_Request>();
}
...
static const _Average_Response_type_support_symbol_names_t _Average_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, assignment1_msgs, srv, Average_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, assignment1_msgs, srv, Average_Response)),
  }
};
...
{
  return &::assignment1_msgs::srv::rosidl_typesupport_cpp::Average_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, assignment1_msgs, srv, Average_Response)() {
  return get_message_type_support_handle<assignment1_msgs::srv::Average_Response>();
}
...
static const _Average_type_support_symbol_names_t _Average_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, assignment1_msgs, srv, Average)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, assignment1_msgs, srv, Average)),
  }
};
...
{
  return &::assignment1_msgs::srv::rosidl_typesupport_cpp::Average_service_type_support_handle;
}
